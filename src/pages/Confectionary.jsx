                    ...
                    <section className="container confectionary">
                        ...
                        <div className="for">
                            ...
                            <div className="for-items">
                                <ForItems
                                    img={'bbscopy/images/confectionary/for1.svg'}
                                    description={t("confectionary.for.description1")}
                                />
                                <ForItems
                                    img={'bbscopy/images/confectionary/for2.svg'}
                                    description={t("confectionary.for.description2")}
                                />
                                <ForItems
                                    img={'bbscopy/images/confectionary/for3.svg'}
                                    description={t("confectionary.for.description3")}
                                />
                                <ForItems
                                    img={'bbscopy/images/confectionary/for4.svg'}
                            ...
                            <div className="confectionary-how__items">
                                <Bounce left>
                                    <div className="confectionary-how__item">
                                        <div className="confectionary-how__item-image">
                                            <img src="bbscopy/images/confectionary/how1.png" alt="basket"/>
                                        </div>
                                ...
                                <Bounce left delay={500}>
                                    <div className="how-arrow">
                                        <img src="bbscopy/images/confectionary/how4.png" alt=""/>
                                    </div>
                                </Bounce>
                                ...
                                <Bounce left delay={1000}>
                                    <div className="confectionary-how__item">
                                        <div className="confectionary-how__item-image">
                                            <img src="bbscopy/images/confectionary/how2.png" alt="basket"/>
                                        </div>
                                        <p className="confectionary-how__item-description">
                                ...
                                <Bounce left delay={2000}>
                                    <div className="confectionary-how__item">
                                        <div className="confectionary-how__item-image">
                                            <img src="bbscopy/images/confectionary/how3.png" alt="basket"/>
                                        </div>
                                        <p className="confectionary-how__item-description">
                        ...
                        <div className="confectionary-partners">
                            ...
                            <div className="confectionary-partners__image">
                                <img src="bbscopy/images/confectionary/partners.png" alt="partners"/>
                            </div>
                        </div>
                        ...
                        <div className="confectionary-partners">
                            ...
                            <div className="confectionary-partners__image">
                                <img src="bbscopy/images/confectionary/clients.png" alt="partners"/>
                            </div>
                        </div>
                    </section>
                </div>
